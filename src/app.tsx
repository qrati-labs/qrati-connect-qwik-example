    ...
    <div class="app">
      ...
      <div class="page-shell">
        <div class="page-frame">
          <header class="hero">
            <p class="hero-kicker">Embeddable Qwik Gallery SDK</p>
            <h1>
              <a href="https://qrati.com" target="_blank" rel="noopener noreferrer">Qrati</a>
              {' '}Connect inside a Qwik host site
            </h1>
            <p class="hero-copy">
              A drop-in web component for embedding live event photo galleries with guest uploads,
              full-screen lightbox, emoji reactions, and contest leaderboards. Resumable Qwik
              execution, controlled host theme, clean link-outs, and zero backend configuration.
            </p>
          ...
          <main class="content-shell">
            <section class="widget-frame" aria-label="Interactive Qwik Event Gallery">
            ...
            <section class="seo-section" aria-labelledby="features-heading">
              <div class="seo-section-header">
                ...
                <p>
                  ...
                  experience embedded directly into your Qwik application with zero backend overhead.
                </p>
              </div>
              ...
              <div class="seo-features-grid">
                ...
                <article class="seo-feature-card">
                  <div class="seo-feature-icon" aria-hidden="true">⚡</div>
                  <h3>Resumable Web Component</h3>
                  <p>
                    Qwik renders custom elements natively with fine-grained reactivity, instant light/dark
                    theme synchronization, and zero initial hydration overhead.
                  </p>
                </article>
              </div>
            </section>
...
// 2. Import Qwik primitives
import { component$, useSignal } from '@builder.io/qwik';

// 3. Render <qrati-connect> in your Qwik component
export const EventGallery = component$(() => {
  const theme = useSignal<'light' | 'dark'>('light');
    ...
    />
            ...
            <section class="seo-section" aria-labelledby="faq-heading">
              <div class="seo-section-header">
                ...
                <p>
                  Everything you need to know about embedding an event photo gallery in Qwik.
                </p>
              </div>
              ...
              <div class="faq-list">
                <details class="faq-item" open>
                  <summary class="faq-question">
                    <span>How do I embed an event photo gallery in Qwik?</span>
                    <span class="faq-icon" aria-hidden="true">+</span>
                  </summary>
                  <div class="faq-answer">
                    Qwik renders custom elements natively without wrappers. Import or load the Qrati Connect element bundle, then render <code style={{ color: 'var(--brand-accent)' }}>&lt;qrati-connect organization-id="YOUR_ORG_ID" theme={theme.value} router="hash" /&gt;</code>. It provides responsive masonry galleries, lightbox, and photo uploads out of the box.
                  </div>
                </details>

                <details class="faq-item">
                  <summary class="faq-question">
                    <span>Can event attendees upload photos directly through the Qwik gallery?</span>
                    <span class="faq-icon" aria-hidden="true">+</span>
                  </summary>
                  <div class="faq-answer">
                ...
                <details class="faq-item">
                  <summary class="faq-question">
                    <span>How does Qwik optimize performance with Qrati Connect web components?</span>
                    <span class="faq-icon" aria-hidden="true">+</span>
                  </summary>
                  <div class="faq-answer">
                    Qwik's resumability architecture avoids eager hydration and only downloads the JavaScript required for user interactions, ensuring instant initial page load times and blazing performance.
                  </div>
                </details>

                <details class="faq-item">
                  <summary class="faq-question">
                    <span>Does the Qrati Connect web component support dark mode in Qwik?</span>
                    <span class="faq-icon" aria-hidden="true">+</span>
                  </summary>
                  <div class="faq-answer">
                    Yes. The component accepts a <code style={{ color: 'var(--brand-accent)' }}>theme</code> attribute (<code style={{ color: 'var(--brand-accent)' }}>'light'</code> or <code style={{ color: 'var(--brand-accent)' }}>'dark'</code>), enabling seamless synchronization with your Qwik application's theme signal and system color preferences.
                  </div>
                </details>

                <details class="faq-item">
                  <summary class="faq-question">
                    <span>Can I run photo contests and display rankings in the Qwik gallery?</span>
                    <span class="faq-icon" aria-hidden="true">+</span>
                  </summary>
                  <div class="faq-answer">
              ...
              <div class="seo-cta-card">
                <div class="seo-cta-content">
                  ...
                  <p class="seo-cta-copy">
                    ...
                    moderation workflows, and a live interactive photo wall embedded in your Qwik application.
                  </p>
                  ...
                  <div class="seo-cta-steps">
                    ...
                    <div class="cta-step">
                      ...
                      <div>
                        ...
                        <p>Drop &lt;qrati-connect&gt; into your Qwik app to display the live mosaic photo stream to all your visitors.</p>
                      </div>
                    </div>
                  </div>
