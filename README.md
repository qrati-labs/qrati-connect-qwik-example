...
Qwik renders custom elements natively. Load the web component bundle and styles once on mount, then render `<qrati-connect>` directly in your Qwik component:
...
- **Drop-in Web Component**: Native Qwik JSX support for custom elements with fine-grained reactivity and resumability.
...
- **Cloudflare Subpath Routing**: Configured for `/connect/qwik-example/` with SPA fallback and runtime GTM handling.
